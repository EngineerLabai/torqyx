...
export default async function Head() {
  ...
  return (
    <>
      <ToolApplicationJsonLd id="bolt-calculator-app-jsonld" data={appSchema} schemaType="WebApplication" />
      {howToSchema ? (
        <HowToJsonLd
          id="bolt-calculator-howto-jsonld"
