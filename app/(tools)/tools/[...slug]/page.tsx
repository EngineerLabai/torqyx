...
import { buildCanonical, buildLanguageAlternates, buildLocalizedCanonical, SITE_URL } from "@/utils/seo";
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  const canonicalUrl = buildCanonical(path) ?? `https://aiengineerslab.vercel.app${path}`;
