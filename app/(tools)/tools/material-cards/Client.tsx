...
type MaterialCardsClientProps = {
  initialDocs?: ToolDocsResponse | null;
};

export default function MaterialCardsPage({ initialDocs }: MaterialCardsClientProps) {
  ...
  return (
    <PageShell>
      <ToolDocTabs slug="material-cards" initialDocs={initialDocs}>
      {/* Başlık + filtre alanı */}
