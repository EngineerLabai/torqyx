...
export default async function Head() {
  ...
  return (
    <>
      <ToolApplicationJsonLd id="basic-engineering-app-jsonld" data={appSchema} schemaType="WebApplication" />
      {howToSchema ? (
        <HowToJsonLd
          id="basic-engineering-howto-jsonld"
      ...
      {notes?.faqs?.length ? (
        <FaqPageJsonLd
          id="basic-engineering-faq-jsonld"
