...
type HeatEnergyClientProps = {
  initialDocs?: ToolDocsResponse | null;
};

export default function HeatEnergyPage({ initialDocs }: HeatEnergyClientProps) {
  return (
    <PageShell>
      <ToolDocTabs slug="heat-energy" initialDocs={initialDocs}>
