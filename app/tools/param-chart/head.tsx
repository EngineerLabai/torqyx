...
export default async function Head() {
  ...
  return (
    <>
      <ToolApplicationJsonLd id="param-chart-app-jsonld" data={appSchema} schemaType="WebApplication" />
      {howToSchema ? (
        <HowToJsonLd
          id="param-chart-howto-jsonld"
