              ...
              <div className="site-container flex items-center justify-between py-3">
                <Link href="/" className="flex items-center gap-3">
                  ...
                  <div className="flex flex-col leading-tight">
                    ...
                    <span className="text-sm font-semibold text-slate-900">Acik ve ozgun muhendislik</span>
                  </div>
                </Link>

                <nav className="hidden items-center gap-2 lg:flex">
                  {navSections.map((section) => {
                    if (section.label === "Hesaplayicilar") {
                      return (
                        <Link
                          key={section.label}
                          href="/tools"
                ...
                <aside className="hidden w-72 shrink-0 xl:block">
                  <div className="sticky top-4 space-y-4 text-xs">
                    <div className="rounded-2xl border border-slate-200 bg-white/80 p-4 shadow-sm backdrop-blur">
                      <h2 className="mb-1 text-sm font-semibold text-slate-900">Premium uyelik</h2>
                      <ul className="list-disc space-y-1 pl-4 text-[11px] text-slate-600">
                        <li>Detayli tork ve dis tablolar</li>
                        <li>Gelismis mekanik hesaplayicilar</li>
                        <li>Malzeme ve kaplama oneri kartlari</li>
                      </ul>
                    </div>
                  </div>
                </aside>
