...
export const metadata: Metadata = {
  title: "Yapay Zeka Mühendisleri Laboratuvarı",
            ...
            <div className="site-container flex items-center justify-between py-3">
              <Link href="/" className="flex items-center gap-3">
                ...
                <div className="flex flex-col leading-tight">
                  <span className="text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-500">AI Engineers Lab</span>
                  <span className="text-sm font-semibold text-slate-900">Açık ve özgün mühendislik</span>
                </div>
              </Link>
                  ...
                  if (section.label === "Hesaplayıcılar") {
                    return (
                      <Link
                        key={section.label}
                        href="/tools"
                        className="flex items-center gap-2 rounded-full px-3 py-2 text-sm font-semibold text-slate-800 nav-link-animated focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300"
                      >
                        {section.label}
                      </Link>
                    );
                  ...
                  if (section.label === "İletişim") {
                    return (
                      <Link
                        key={section.label}
                        href="/support"
                        className="flex items-center gap-2 rounded-full px-3 py-2 text-sm font-semibold text-slate-800 transition hover:bg-white/70 hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-slate-300"
                      >
                        {section.label}
                      </Link>
                    );
            ...
            {section.links.map((link, idx) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-[11px] font-mono text-gray-500">{link.href}</p>
                  {link.badge ? (
