...
const COPY = {
  tr: {
    ...
    description:
      "Boyut, dayanım sınıfı ve ampirik tork faktörü K ön ayarına göre ön yük ile sıkma torkunu hesapla. K, tek başına sürtünme katsayısı değildir.",
    ...
    grade: "Kalite sınıfı",
    friction: "Tork faktörü K ön ayarı",
    preload: "Ön yük seviyesi [%Re]",
    exampleDiameter: "Örn. 8",
    examplePitch: "Örn. 1.25",
    frictionOptions: {
      dry: "Kuru için ön ayar (K = 0,25)",
      oiled: "Hafif yağlı için ön ayar (K = 0,20)",
      coated: "Kaplamalı için ön ayar (K = 0,18)",
    },
  },
  en: {
    ...
    friction: "Torque-factor K preset",
    preload: "Preload level [%Re]",
    exampleDiameter: "e.g. 8",
    examplePitch: "e.g. 1.25",
    frictionOptions: {
      dry: "Dry preset (K = 0.25)",
      oiled: "Lightly oiled preset (K = 0.20)",
      coated: "Coated preset (K = 0.18)",
    },
  },
} as const;
