  ...
  return (
    <div className="space-y-4 text-sm">
      <div className="space-y-1">
        <h2 className="text-sm font-semibold text-slate-900">Hangi dönüşümü yapmak istiyorsun?</h2>
        <p className="text-xs text-slate-500">
          Önce kategoriyi seç, sonra kaynak ve hedef birimi belirle. Değeri girdiğinde
          sonuç otomatik güncellenir.
        </p>
      </div>

      <div className="space-y-3 text-xs">
        <div className="space-y-1">
          <label className="block text-[11px] font-medium text-slate-700">Hangi kategori üzerinde çalışıyorsun?</label>
          <select
        ...
        <div className="grid gap-2 sm:grid-cols-[minmax(0,1fr)_auto_minmax(0,1fr)]">
          <div className="space-y-1">
            <label className="block text-[11px] font-medium text-slate-700">Hangi birimden başlıyorsun?</label>
            <select
          ...
          <div className="space-y-1">
            <label className="block text-[11px] font-medium text-slate-700">Hangi birime dönüşecek?</label>
            <select
              value={input.toUnit}
        ...
        <div className="space-y-1">
          <label className="block text-[11px] font-medium text-slate-700">Kaç birim?</label>
          <input
            type="number"
            inputMode="decimal"
            value={input.value}
