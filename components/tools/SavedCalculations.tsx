  ...
  const copy =
    locale === "en"
      ? {
          ...
          emptyHint: 'Use the "Save" button inside a tool to create one.',
          toolLibrary: "Go to Tool Library",
          reopen: "Open again",
          delete: "Delete",
      ...
      : {
          ...
          emptyHint: 'Bir aracta "Kaydet" butonunu kullanarak kayit olusturabilirsin.',
          toolLibrary: "Tool Library'ye git",
          reopen: "Tekrar Ac",
          delete: "Sil",
