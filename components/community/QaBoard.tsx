...
const topics: Topic[] = [
  ...
  },
  {
    ...
    details:
      "300x500x10 mm plakayı köşe kaynak ile birleştirdikten sonra sehim oluştu; fikstürleme ve ön ısıtma önerisi?",
    updated: "5 saat önce",
...
const answersByTopic: Record<string, Answer[]> = {
  ...
  "kaynak-sonrasi-sehim": [
    { user: "Hakan", text: "Simetrik puntolar ve karşılıklı kaynat, sonra tamamını doldur. Ön ısı 120-150°C ise yarar.", time: "10dk önce" },
    ...
    <>
      <section className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="space-y-3">
          ...
          <h1 className="text-2xl font-semibold leading-snug text-slate-900">Soru-cevap alanı</h1>
          <p className="text-sm leading-relaxed text-slate-700">
            Soru sor, kısa yanıtlar al ve deneyim paylaş.
          </p>
        </div>
      </section>
