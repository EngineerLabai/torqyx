...
const SUSPICIOUS_RULES: SuspiciousRule[] = [
  ...
  { pattern: /\bCivata\b/, suggestion: "Cıvata" },
  { pattern: /\bParca\b/, suggestion: "Parça" },
  { pattern: /\bNasil\b/, suggestion: "Nasıl" },
  { pattern: /\bKullanilir\b/, suggestion: "Kullanılır" },
  { pattern: /\bIlgili\b/, suggestion: "İlgili" },
  { pattern: /\bAraclar\b/, suggestion: "Araçlar" },
  { pattern: /\bBasinc\b/, suggestion: "Basınç" },
  { pattern: /\bKaybi\b/, suggestion: "Kaybı" },
  { pattern: /\bHesabi\b/, suggestion: "Hesabı" },
