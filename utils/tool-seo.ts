...
export const buildToolJsonLd = (toolKey: string, locale: Locale): WebApplicationSchemaInput => {
  ...
  return {
    ...
    applicationCategory: seo.tool?.type === "guide" ? "ReferenceApplication" : "UtilitiesApplication",
    applicationSubCategory: seo.tool?.category === "Mechanical" ? "Mechanical engineering utility" : "Engineering utility",
    operatingSystem: "Web",
